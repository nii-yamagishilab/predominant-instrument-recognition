...
from src.models.resnet50 import IRResNet50
...
class InstrumentRecognizer(pl.LightningModule):
    def __init__(self, **kwargs,
        ...
        self.model = IRResNet50(init_mlp=self.hparams.init_mlp,
                                n_fft=self.hparams.n_fft,
                                normalize=self.hparams.normalize,
                                discretize=self.hparams.discretize,
                                p_spec_aug=self.hparams.p_spec_aug,
                                )
    ...
    def training_step(self, batch, batch_idx):
        ...
        # outputs = outputs / self.hparams.temperature
